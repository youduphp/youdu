...
class Group
{
    ...
    public function lists($userId = ''): array
    {
        ...
        $resp = $this->client->get($this->app->url('/cgi/group/list'), $parameters);
    ...
    public function create(string $name): int|string
    {
        ...
        $resp = $this->client->post($this->app->url('/cgi/group/create'), $parameters);
    ...
    {
        $resp = $this->client->get($this->app->url('/cgi/group/delete'), ['groupId' => $groupId]);
        $decoded = json_decode($resp['body'], true, 512, JSON_THROW_ON_ERROR);
    ...
    public function update(string $groupId, string $name): bool
    {
        ...
        $resp = $this->client->post($this->app->url('/cgi/group/update'), $parameters);
    ...
    {
        $resp = $this->client->get($this->app->url('/cgi/group/info'), ['id' => $groupId]);
        $decoded = json_decode($resp['body'], true, 512, JSON_THROW_ON_ERROR);
    ...
    public function addMember(string $groupId, array $members = []): bool
    {
        ...
        $resp = $this->client->post($this->app->url('/cgi/group/addmember'), $parameters);
    ...
    public function delMember(string $groupId, array $members = []): bool
    {
        ...
        $resp = $this->client->post($this->app->url('/cgi/group/delmember'), $parameters);
    ...
    {
        $resp = $this->client->get($this->app->url('/cgi/group/ismember'), ['id' => $groupId, 'userId' => $userId]);
        $decoded = json_decode($resp['body'], true, 512, JSON_THROW_ON_ERROR);
