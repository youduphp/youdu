...
class Session
{
    ...
    public function create(string $title, string $creator = '', array $member = [], string $type = 'multi'): array
    {
        ...
        $resp = $this->client->post($this->app->url('/cgi/session/create'), $parameters);
    ...
    public function update(string $sessionId, string $opUser = '', string $title = '', array $addMember = [], array $delMember = []): array
    {
        ...
        $resp = $this->client->post($this->app->url('/cgi/session/update'), $parameters);
    ...
    {
        $resp = $this->client->get($this->app->url('/cgi/session/get'), ['sessionId' => $sessionId]);
    ...
    public function send(Message $message): bool
    {
        ...
        $resp = $this->client->post($this->app->url('/cgi/session/send'), $parameters);
